...
export const PARSE_SYSTEM_PROMPT = [
  ...
  'actual_cost_minor means the economic cost attributed to this purchase.',
  'For ordinary payment, actual_cost_minor is the amount paid at this checkout.',
  'discount_minor means the effective saving attributed to this purchase.',
  ...
  'For a discounted voucher stated as purchase cost C for face value F (C抵F), use only the facts in this note.',
  'The voucher face value F reduces the checkout bill, but its purchase cost C remains part of this purchase cost.',
  'Therefore effective discount is F-C and actual_cost_minor is list_price_minor-F+C.',
  'Do not treat the full face value F as discount when the voucher purchase cost C is stated.',
  ...
  '(category|other).',
  'Use category only for the single consumption category used in the 100% breakdown.',
  'Use other for trip, place, person, purpose, channel, and any overlapping context.',
  'Merchant belongs in the merchant field, never in a merchant tag type.',
  'Treat 旅游 as a category for travel-related spending.',
  'Treat specifically named trip contexts such as 江西旅游 as other.',
  ...
  '',
  'DISCOUNTED VOUCHER EXAMPLE INPUT:',
